...
UserSchema.methods.toJSON=function(){
	...
	return _.pick(userObject,['reference_token','name','admission_no','email','contact_number','username','score','stage','mission_state','duel_lost','duel_won','drop_count','avtarID']); 
}
